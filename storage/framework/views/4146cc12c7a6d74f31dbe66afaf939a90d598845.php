...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <?php if($payment->id == $order->payment_methods_id): ?>
                    <option value="<?php echo e($payment->id); ?>" selected > <?php echo e($payment->name); ?></option>
                <?php else: ?>
...
<div class="row">
    ...
    <table class="table mt-3">
        ...
        <?php if(old('products')): ?>
                        ...
                        <select name="products[<?php echo e($rowId); ?>][product_id]"
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($product->id == $rowProduct['product_id']): ?>
                                    <option value="<?php echo e($product->id); ?>" selected data-price="<?php echo e($product->price); ?>" selected>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php else: ?>
        <?php $__currentLoopData = $order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr id="product-1">
                <td>
                    <select name="products[1][product_id]"
                        ...
                        <?php if( $product->id == $order->id): ?>
                            <option value="<?php echo e($product->id); ?>" data-price="<?php echo e($product->price); ?>" selected>
                                <?php echo e($product->name); ?> | <?php echo e($product->price); ?>
                ...
                <td>
                    <input type="number"
                           ...
                           value="<?php echo e($order->pivot->quantity); ?>"
                           row-id="product-1"
                           class="form-control input-product-quantity">
                </td>
                <td>
                    <input type="number"
                           ...
                           class="form-control input-product-price"
                           row-id="product-1"
                           value="<?php echo e($order->pivot->price); ?>">
                </td>
                <td>
                    <input type="number"
                           ...
                           class="form-control input-product-total"
                           row-id="product-1"
                           value="<?php echo e($order->pivot->total); ?>">
                </td>
                <td>
...
<?php /**PATH C:\Users\Lenovo\full-stack-mshop-master\resources\views/admin/order/formupdate.blade.php ENDPATH**/ ?>